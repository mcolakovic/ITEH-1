...
?>
    ...
    <body>
        ...
        <div id="pregled" class="panel panel-success" style="margin-top: 1%;">
            ...
            <div class=" col-md-3" style="text-align: right">
                <button id="btn-izmeni" class="btn btn-primary btn-block" data-toggle="modal" data-target="#izmijeniModal">Izmijeni</button>
            </div>
                            ...
                            <form action="#" method="post" id="izmijeniForm">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <input id="proizvod" type="text" name="proizvodI" class="form-control" placeholder="Proizvod *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input id="proizvodjac" type="text" name="proizvodjacI" class="form-control" placeholder="Proizvodjac *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input id="velicina" type="text" name="velicinaI" class="form-control" placeholder="Velicina *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input id="materijal" type="text" name="materijalI" class="form-control" placeholder="Materijal *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <input id="boja" type="text" name="bojaI" class="form-control" placeholder="Boja *" value="" />
                                        </div>
                                        <div class="form-group">
